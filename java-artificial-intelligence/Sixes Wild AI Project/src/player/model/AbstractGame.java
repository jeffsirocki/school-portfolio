...
public abstract class AbstractGame {
	 ...
	 * Can be overridden to increment a move counter in appropriate game modes
	 */
	...
	/**
	 * Returns a metric representing how "good" this move is
	 * by default, higher scores are better.
	 * Override this method to vary evaluation based on game mode
	 * @param move
	 * @return
	 */
	public double evaluateMove(AbstractMove move){
